...
MODULE PROBLEM_CONSTANTS
  ...
  INTEGER(INTG), PARAMETER :: PROBLEM_NAVIER_STOKES_DIFFUSION_ADVECTION_DIFFUSION_TYPE=9
...
!!TODO: We don't really have two problem types here? Maybe a different type with nonlinear boundary conditions???
  ...
  !Subtype for thermoregulation
  INTEGER(INTG), PARAMETER :: PROBLEM_THERMOREGULATION_SUBTYPE=10
  ...
  INTEGER(INTG), PARAMETER :: PROBLEM_THERMOREGULATION_DIFFUSION_ADVEC_DIFFUSION_SUBTYPE=123
  INTEGER(INTG), PARAMETER :: PROBLEM_COUPLED_BIOHEAT_NAVIERSTOKES_DIFF_ADV_DIFF_SUBTYPE=124
